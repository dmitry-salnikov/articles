As I've already mentionned in a [previous post](file:///carbons-manhole/), at [$work](http://saymedia.com) we are currently deploying Graphite and the usual suspects.
