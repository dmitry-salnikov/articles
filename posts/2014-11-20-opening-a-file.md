...
The function is defined in [fs/open.c](http://lxr.free-electrons.com/source/fs/open.c#L992), and do a call to [do\_sys\_open](http://lxr.free-electrons.com/source/fs/open.c#L964).
